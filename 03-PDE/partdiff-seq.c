...
/* ************************************************************************ */
static inline double getResiduum(struct calculation_arguments* arguments, struct options* options, int x, int y, double star)
{
    if (options->inf_func == FUNC_F0) {
        return (-star) / 4.0; 
    } else {
        double pih_y = y * PI * arguments->h; 
        double pih_x = x * PI * arguments->h; 
        return (TWO_PI_SQUARE * sin(pih_y) * sin(pih_x) * arguments->h * arguments->h - star) / 4.0; 
    }
}
/* ************************************************************************ */
